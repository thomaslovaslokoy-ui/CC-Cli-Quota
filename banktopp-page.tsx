...
const SEED_BANKS: Bank[] = [
  ...
  { id:"b015",slug:"varo-bank-basic",name:"Varo Bank",type:"neobank",description:"Full neobank with FDIC-insured savings and a path to 5.00% APY.",rating:4.2,is_sponsored:false,affiliate_url:null,logo_url:null,pros:["Up to 5.00% APY (conditions)","No monthly fees","Early paycheck"],cons:["High APY has conditions","Limited customer service"],established:2015,ratings:{app:4.3,fees:4.5,returns:4.0,access:4.0,support:3.3,security:4.4},apy:5.00,monthly_fee:0,min_balance:0,fdic_insured:true,signup_bonus:null,atm_fee:false,mobile_only:true },
  ...
  { id:"b033",slug:"step-teen-basic",name:"Step (Teen Banking)",type:"student",description:"Build credit from day one with Step's teen-focused secured card and banking.",rating:4.3,is_sponsored:false,affiliate_url:null,logo_url:null,pros:["Credit building for teens","No fees","Parental controls","5% APY savings"],cons:["Under 18 or parent account","Limited features for adults"],established:2019,ratings:{app:4.5,fees:5.0,returns:4.2,access:3.8,support:4.0,security:4.4},apy:5.00,monthly_fee:0,min_balance:0,fdic_insured:true,signup_bonus:null,atm_fee:false,mobile_only:true },
  { id:"b034",slug:"greenlight-family",name:"Greenlight",type:"student",description:"Family banking with chores, allowances, investing for kids, and parental controls.",rating:4.5,is_sponsored:false,affiliate_url:null,logo_url:null,pros:["5 family members","Chore tracking","Kids investing","Strong parental controls"],cons:["Monthly fee $5.99+","Lower APY vs top HYSA","App focused"],established:2014,ratings:{app:4.7,fees:3.8,returns:3.5,access:4.0,support:4.3,security:4.6},apy:2.00,monthly_fee:5.99,min_balance:0,fdic_insured:true,signup_bonus:null,atm_fee:false,mobile_only:true },
...
export const LIVE_MARKET_RATES = [
  ...
  { label: "10-Year Treasury", value: "4.30%", change: "+0.08", up: true, category: "treasury" },
  { label: "30-Year Treasury", value: "4.50%", change: "+0.06", up: true, category: "treasury" },
  ...
  { label: "Mortgage 30yr Fix", value: "7.04%", change: "+0.12", up: true, category: "lending" },
  { label: "Mortgage 15yr Fix", value: "6.42%", change: "+0.08", up: true, category: "lending" },
  { label: "ARM 5/1 Rate", value: "6.15%", change: "+0.05", up: true, category: "lending" },
  { label: "HELOC Prime+1.5%", value: "10.00%", change: "+0.00", up: null, category: "lending" },
  { label: "Auto Loan 60mo", value: "7.02%", change: "+0.11", up: true, category: "lending" },
  { label: "Personal Loan Avg", value: "11.48%", change: "+0.15", up: true, category: "lending" },
...
const TICKER_DATA = [
  ...
  { label: "Mortgage 30yr Fix", value: "7.04%", change: "+0.12", up: true },
  ...
  { label: "10-Year Treasury", value: "4.30%", change: "+0.08", up: true },
  { label: "I-Bond Rate", value: "5.27%", change: "+0.40", up: true },
  { label: "Mortgage 15yr Fix", value: "6.42%", change: "+0.08", up: true },
  { label: "Auto Loan 60mo", value: "7.02%", change: "+0.11", up: true },
  ...
  { label: "Personal Loan Avg", value: "11.48%", change: "+0.15", up: true },
];
