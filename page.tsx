...
const TICKER_DATA = [
  ...
  { label: "Mortgage 30yr", value: "7.04%", change: "+0.12", up: false },
...
function ComparePage() {
  ...
  const COMPARE_ROWS: { label: string; key: keyof Bank; format?: (v: unknown) => string }[] = [
    ...
    { label: "Branch Count", key: "branch_count", format: v => v ? String(v).toLocaleString() : "Online only" },
